...
def parse_args():
    ...
    parser.add_argument('--dataset_path', dest='dataset_path',
                        help='caltech dataset path', default=None, type=str)
    parser.add_argument('--max_iters', dest='max_iters',
                        help='max iterations', default=16000, type=int)
    parser.add_argument('--output_dir', dest='output_dir',
                        help='output_dir', default=None, type=str)
    parser.add_argument('--rng_seed', dest='rng_seed',
                        help='random number generator seed', default=3, type=int)
...
def get_solvers(net_name):
    ...
    print solvers
    print '-------------------'
    # Iterations for each training tage
    max_iters = [args.max_iters]
    #max_iters = [80000]
    # max_iters = [100, 100, 100, 100]
    # Test prototxt for the RPN
    rpn_test_prototxt = os.path.join(
        cfg.MODELS_DIR, net_name, 'stage1_rpn_train.pt')
...
def _init_caffe(cfg):
    ...
    """
    print 'using rng seed: ', cfg.RNG_SEED
...
if __name__ == '__main__':
    ...
    print 'model_path: ' + rpn_stage1_out['model_path']
    p.join()
