...
def parse_args():
    ...
    parser.add_argument('--net', dest='caffemodel',
                        help='model to test',
                        default="/home/yxchen/py-faster-rcnn/output/default/caltech_train/REDUCE1/vgg16_rpn_stage1_iter_16000.caffemodel", type=str)
...
if __name__ == '__main__':
    ...
    import glob
    imdb = glob.glob("/home/yxchen/RPN_BF/datasets/caltech/test/images/*.jpg")
    
    _t = Timer()
    imdb_boxes = [[] for _ in xrange(len(imdb))]
    for i in xrange(len(imdb)):
        with open(os.path.join(args.output_dir, imdb[i][-21:] + ".txt"), "w") as f:
